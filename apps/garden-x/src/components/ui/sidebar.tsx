        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>{ui(preferredLanguage(), "sidebar")}</SheetTitle>
              <SheetDescription>{ui(preferredLanguage(), "mobileSidebarDescription")}</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">{ui(preferredLanguage(), "toggleSidebar")}</span>
    </Button>
  );
});
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        data-sidebar="rail"
        aria-label={ui(preferredLanguage(), "toggleSidebar")}
        tabIndex={-1}
        onClick={toggleSidebar}
        title={ui(preferredLanguage(), "toggleSidebar")}
        className={cn(
