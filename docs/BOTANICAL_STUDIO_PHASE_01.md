...
4. **Fase 03 — extensión del sistema visual.** Home, Jardines, Hoy y Ask Garden cerrados localmente y aceptados en `6cc1eba`, con funcionalidad y presentación aprobadas. QA autenticada/física pendiente. [Guía y cierres](BOTANICAL_STUDIO_PHASE_03.md).
5. **Preflight de Fase 04 — Experience Consolidation.** Mapa transversal, inconsistencias, candidatos y QA preparados con Sol High. Consolidación todavía no iniciada; siguiente bloque y revisión global recomendados con Astra xhigh, tras confirmación. [Preflight](BOTANICAL_STUDIO_PHASE_04_PREFLIGHT.md).
