...
const fixture = resolve('qa/depth-study-api.ts')
const overrides = ['getHomeMedia', 'getGardenCoverPhotos', 'getCycle', 'getGarden', 'getSignedPhotoUrl', 'getHome', 'getHomeDashboard', 'getAttention', 'getControlV2', 'acknowledgeHomeSnapshot', 'getOpenMaintenanceSession', 'getMaintenanceSession', 'progressMaintenancePosition', 'setMaintenanceSessionState']
