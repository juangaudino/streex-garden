...
export function QaCollections() {
  ...
  const initialEntry = params.get('surface') === 'gardens' ? '/gardens' : '/'
  ...
  if (!initialized.current) { resetScenario(initialScenario); initialized.current = true }
  ...
  return <>{!embedded && <aside aria-label="Controles de QA aislada"><strong>QA AISLADA HOME / JARDINES · Medios sintéticos · Sin cuenta ni servicios reales · CSS de colección aplicada</strong>
