...
const generatedMachineFacts = path.join(
  root,
  "apps",
  "garden-x",
  "src",
...
// inferred from their editable names or position counts.
const systemDefinitionMachineModels = {
  uruq_8_v1: "uruq-hp-gc001",
  uruq_12_v1: "uruq-hp-gc202",
};
