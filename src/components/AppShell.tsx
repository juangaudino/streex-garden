...
interface AppShellProps extends PropsWithChildren {
  presentation?: 'cycle' | 'maintenance' | 'story' | 'plant' | 'collection-home' | 'collection-gardens' | 'today' | 'ask'
  title?: string
  subtitle?: string
  backTo?: string
  onRegister?: () => void
...
export function AppShell({ children, title, subtitle, backTo, actions, presentation, onRegister, registerDisabled = false }: AppShellProps) {
