...
export function MaintenancePage() {
  ...
  return <AppShell presentation="maintenance" title="Mantenimiento" subtitle={session ? `${inspected} revisadas · ${healthy} se ven bien · ${skipped} omitidas` : 'Cargando sesión'} backTo="/">
