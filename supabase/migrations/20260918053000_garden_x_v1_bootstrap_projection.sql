-- Garden X V1 — canonical bootstrap read model for the approved Lovable frontend.
-- Presentation remains in Lovable; this RPC exposes one consistent backend truth.
begin;
